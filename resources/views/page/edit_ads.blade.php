  ...
  <body>
    ...
    <div class="container">
        ...
        <form action="{{url('create_ads')}}" onsubmit="return validate()" name="createForm" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="row mt-4 mb-5 text-muted">
                <div class="col-md-4">
                    <h4 class="text-primary">Pilih Kategori Iklan</h4>
                    <div class="small text-muted">Kategori wajib dipilih</div>
                    <div class="mt-4"><hr></div>
                    <fieldset id="category">
                        <label class="container_2">ELEKTRONIKA
                            <input type="radio" name="category" value="Elektronik">
                            <span class="checkmark"></span>
                        </label>
                        <hr>
                        <label class="container_2">PROPERTI
                            <input type="radio" name="category" value="Properti">
                            <span class="checkmark"></span>
                        </label>
                        <hr>
                        <label class="container_2">KENDARAAN
                            <input type="radio" name="category" value="Kendaraan">
                            <span class="checkmark"></span>
                        </label>
                        <hr>
                        <label class="container_2">RUMAH TANGGA
                            <input type="radio" name="category" value="Rumah Tangga">
                            <span class="checkmark"></span>
                        </label>
                        <hr>
                        <label class="container_2">KEBUTUHAN ANAK
                            <input type="radio" name="category" value="Kebutuhan Anak">
                            <span class="checkmark"></span>
                        </label>
                        <hr>
                        <label class="container_2">HOBBY
                            <input type="radio" name="category" value="Hobby">
                            <span class="checkmark"></span>
                        </label>
                        <hr>
                        <label class="container_2">ALAT SEKOLAH
                            <input type="radio" name="category" value="Alat Sekolah">
                            <span class="checkmark"></span>
                        </label>
                    </fieldset>
                </div>
                ...
                <div class="col-md-8">
                    ...
                    <div class="mt-4">
                        ...
                        rows="5"
                        value=""
                        class="form-control @error('desc') is-invalid @enderror">{{$ads[0]->desc}}</textarea>
                        @error('desc')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
